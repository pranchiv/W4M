    ...
    <div role="main" class="ui-content">
        ...
        <form id="register_form">
            <div class="ui-field-contain">
                <label for="RegistrationType" style="white-space: nowrap;">What role?</label>
            ...
            <button id="register_registerButton" class="ui-btn ui-btn-b ui-corner-all">Start Registration</button>
