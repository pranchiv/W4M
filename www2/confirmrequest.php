...
<html>
<head>
<title>Wheels4Meals</title><!--driver confirm request-->
<meta charset="utf-8">
...
<div class="wrapper row3">
	<div class="container low-pad-top">
        ...
        <?php
		$query = "select * from Donation where addDate >= '$dateToday' and foodStatus = 'Hold' and donorId in (select donorId from pickuporder where driverId = $driverId)";
				...
				?>
                    <div class="tabl-row">
                        <div class="checkbox">
                            ...
                            <p class="yes"><!--<input type="checkbox"> --><a href="availablerecipient.php?reqrec=<?=$recdata['id']?>">Click Here</a> See List of Available Recipients</p>
                        </div>
                    </div>
                <?php
				$count++;
		...
		?>  
            ...
            <button type="submit" name="sbt" class="btn_class">Confirm</button>
        </form>
    </div>
</div>
